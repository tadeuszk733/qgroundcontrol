...
class MotorAssignmentController : public QObject
{
    Q_OBJECT
public:
    MotorAssignmentController(QObject* parent, Vehicle* vehicle, QmlObjectListModel* actuators);

    virtual ~MotorAssignmentController() = default;
